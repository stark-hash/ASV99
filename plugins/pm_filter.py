...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNELS, AUTH_USERS, SUPPORT_CHAT_ID, SUPPORTS_CHAT_ID, SUPPORT_CHAT, CUSTOM_FILE_CAPTION, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
...
async def give_filter(client, message):
    if message.chat.id != SUPPORTS_CHAT_ID:
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("🧑‍💻 DEV", url=f"t.me/AS_Creator1"),
                    InlineKeyboardButton("👨‍💻 DEV", url=f"t.me/TGTesla")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
